    ...
    return (
        <RecruitmentLayout>
            ...
            <section className="pt-40 pb-20 bg-white relative overflow-hidden">
                <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#EEF8F9]/50 to-transparent -z-10"></div>
                <div className="max-w-7xl mx-auto px-12">
                    <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-20">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#EEF8F9] text-[#006D7E] rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-6 border border-[#006D7E]/10">
                                <Sparkles className="h-3 w-3 animate-pulse" /> KHÁM PHÁ CƠ HỘI
                            </div>
                            <h1 className="text-7xl font-black text-[#004D5C] tracking-tighter italic leading-none">
                        ...
                        >
                            <div className="relative group">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-[#f8fafc] border-none rounded-[32px] pl-16 pr-8 py-6 text-sm font-bold text-[#004D5C] focus:ring-4 focus:ring-[#006D7E]/10 transition-all duration-500 shadow-inner italic"
                                />
                    ...
                    >
                        <AnimatePresence mode='popLayout'>
                            {filteredJobs.map((job, index) => (
                                ...
                                >
                                    <Link 
                                        href={`/jobs/${job.id}`}
                                        className="bg-white p-8 md:p-12 rounded-[48px] border border-slate-50 shadow-sm hover:shadow-2xl hover:shadow-[#006D7E]/5 transition-all duration-700 flex flex-col md:flex-row md:items-center justify-between gap-8 group overflow-hidden relative"
                                    >
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-center gap-4 mb-4">
                                                <div className="px-3 py-1 bg-[#EEF8F9] text-[#006D7E] rounded-full text-[9px] font-black uppercase tracking-widest border border-[#006D7E]/5">
                                                    {job.type}
                                                </div>
                                                <div className="text-[10px] font-bold text-slate-300 uppercase tracking-widest italic">POSTED RECENTLY</div>
                                            </div>
                                            <h3 className="text-3xl font-black text-[#004D5C] italic tracking-tight group-hover:text-[#006D7E] transition-colors duration-500 mb-6">{job.title}</h3>
                                        ...
                                        <div className="flex items-center gap-10">
                                            <div className="hidden lg:block text-right">
                                                <div className="text-[10px] font-black text-slate-300 uppercase tracking-widest mb-1 italic">Yêu cầu</div>
                                                <div className="text-sm font-black text-[#004D5C] italic">Senior Experience</div>
                                            </div>
                                            <motion.div 
                                                whileHover={{ x: 5 }}
                                                className="h-20 w-20 rounded-full border border-slate-100 flex items-center justify-center group-hover:bg-[#006D7E] group-hover:border-[#006D7E] transition-all duration-700 shadow-sm"
                                            >
                                                <ChevronRight className="h-8 w-8 text-slate-400 group-hover:text-white transition-all duration-500" />
                                            </motion.div>
                                        </div>
                                    </Link>
                                </motion.div>
                        ...
                        {filteredJobs.length === 0 && (
                            ...
                            >
                                ...
                                <h3 className="text-2xl font-black text-[#004D5C] italic mb-2 tracking-tighter">Không tìm thấy vị trí phù hợp</h3>
                                <p className="text-slate-400 font-medium italic">Hãy thử tìm kiếm với từ khóa khác hoặc quay lại sau.</p>
                            </motion.div>
                        )}
                    </motion.div>
                </div>
            ...
            <section className="py-40 bg-slate-50 border-t border-slate-100 relative">
                 <div className="max-w-7xl mx-auto px-12">
